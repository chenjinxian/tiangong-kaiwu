...
/**
 * LubanCAD application options
 * @public
 */
export interface LubanCadOptions extends IModelAppOptions {
...
/**
 * Main application class for LubanCAD.
 * Extends IModelApp to provide CAD-specific functionality.
 * @public
 */
export class LubanCadApp extends IModelApp {
  ...
  /**
   * Initialize the LubanCAD application
   * @param options - Application configuration options
   */
  public static override async startup(options?: LubanCadOptions): Promise<void> {
...
/**
 * Initialize LubanCadApp for the current platform
 * @public
 */
export async function initializeLubanCad(options?: LubanCadOptions): Promise<void> {
  await LubanCadApp.startup(options);
}
