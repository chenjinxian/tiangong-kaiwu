# LubanCAD - Core UX Rewrite Implementation Plan (Sections 1,2,3,4,7)
...
**Files:**
- Create: `luban-cad/apps/web/src/app/contexts/UserContext.tsx`
- Create: `luban-cad/apps/web/src/app/providers/QueryProvider.tsx`
- Create: `luban-cad/apps/web/src/features/auth/services/auth/client.ts`
- Create: `luban-cad/apps/web/src/features/itwin/hooks/useITwinsQuery.ts`
- Create: `luban-cad/apps/web/src/features/itwin/components/CreateITwinDialog.tsx`
- Create: `luban-cad/apps/web/src/features/imodel/hooks/useIModelsQuery.ts`
- Create: `luban-cad/apps/web/src/features/imodel/hooks/useIModelPermission.ts`
- Create: `luban-cad/apps/web/src/features/imodel/components/CreateIModelWorkflow.tsx`
- Create: `luban-cad/apps/web/src/features/editor/components/CadToolbar.tsx`
- Create: `luban-cad/apps/web/src/features/editor/components/ThemeToggle.tsx`
- Create: `luban-cad/apps/web/src/features/editor/hooks/useEditTools.ts`
- Create: `luban-cad/apps/web/src/features/version-control/hooks/useChangesets.ts`
- Create: `luban-cad/apps/web/src/shared/components/skeletons/DocumentsSkeleton.tsx`
- Create: `luban-cad/apps/web/src/shared/components/skeletons/ITwinDetailSkeleton.tsx`
...
- [ ] **Step 3:** Run type check: `cd luban-cad/apps/web && npx tsc --noEmit`
...
**Files:**
- Modify: `luban-cad/apps/web/src/pages/Register/Register.tsx`
...
**Files:**
- Modify: `luban-cad/apps/web/src/pages/Login/Login.tsx`
- Modify: `luban-cad/apps/web/src/features/auth/services/auth/client.ts`
...
**Files:**
- Modify: `luban-cad/apps/web/src/pages/Documents/Documents.tsx`
- Modify: `luban-cad/apps/web/src/features/itwin/hooks/useITwinsQuery.ts`
...
**Files:**
- Modify: `luban-cad/apps/web/src/pages/ITwinDetail/ITwinDetail.tsx`
- Create: `luban-cad/apps/web/src/features/itwin/components/EditITwinDialog.tsx`
...
**Files:**
- Modify: `luban-cad/apps/web/src/pages/ITwinDetail/ITwinDetail.tsx`
- Modify: `luban-cad/apps/web/src/features/imodel/services/client.ts` (create if missing)
...
**Files:**
- Modify: `luban-cad/apps/web-agent/src/webhook-server.ts`
- Modify: `luban-cad/apps/web-agent/src/baseline-generator.ts`
- Modify: `luban-cad/apps/backend/src/main.ts`
- Modify: `luban-cad/apps/web/src/pages/ITwinDetail/ITwinDetail.tsx`
...
**Files:**
- Modify: `luban-cad/apps/web/src/pages/Editor/Editor.tsx`
...
**Files:**
- Modify: `luban-cad/apps/web/src/pages/Editor/Editor.tsx`
- Create: `luban-cad/apps/web/src/features/editor/components/BriefcaseStatus.tsx`
- Create: `luban-cad/apps/web/src/features/editor/components/BriefcaseStatusBar.tsx`
- Create: `luban-cad/apps/web/src/features/imodel/hooks/useBriefcase.ts`
...
**Files:**
- Modify: `luban-cad/apps/web/src/pages/Editor/Editor.tsx`
- Create: `luban-cad/apps/web/src/features/editor/components/EditorSidebar.tsx`
...
**Files:**
- Create: `luban-cad/apps/web/src/core/gizmo/TransformGizmo.ts`
- Create: `luban-cad/apps/web/src/core/gizmo/useTransformGizmo.ts`
- Modify: `luban-cad/apps/web/src/pages/Editor/Editor.tsx`
...
**Files:**
- Create: `luban-cad/apps/web/src/features/editor/hooks/useAutoSave.ts`
- Modify: `luban-cad/apps/web/src/pages/Editor/Editor.tsx`
...
**Files:**
- Modify: `luban-cad/apps/web/src/features/version-control/components/ChangesetTimeline.tsx`
...
**Files:**
- Modify: `luban-cad/apps/web/src/features/version-control/components/ChangesetCompare.tsx`
- Modify: `luban-cad/apps/web/src/features/editor/components/EditorSidebar.tsx`
