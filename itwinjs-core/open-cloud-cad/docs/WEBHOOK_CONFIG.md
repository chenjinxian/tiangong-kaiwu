...
**文件**: `~/Documents/GitHub/imodelhub-services/.env`
...
**文件**: `~/Documents/GitHub/itwinjs-core/open-cloud-cad/apps/web-agent/.env`
...
```
imodelhub-services/.env                    web-agent/.env
─────────────────────────                  ──────────────
...
# open-cloud-cad/apps/web-agent/.env
...
```bash
cd ~/Documents/GitHub/imodelhub-services
...
pkill -f "imodelhub"
cd ~/Documents/GitHub/imodelhub-services && node -r dotenv/config dist/main.js

# 重启 web-agent
pkill -f "web-agent"
cd ~/Documents/GitHub/itwinjs-core/open-cloud-cad/apps/web-agent && node dist/main.js
```
...
### 检查 web-agent 的 secret

```bash
cd ~/Documents/GitHub/itwinjs-core/open-cloud-cad/apps/web-agent
...
**原因**: imodelhub-services 和 web-agent 的 secret 不匹配
