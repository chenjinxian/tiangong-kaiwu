...
if [ ! -d "common/temp/node_modules" ]; then
...
# Verify key packages
PACKAGES=(
    "open-cloud-cad/apps/web"
    "open-cloud-cad/apps/backend"
    "open-cloud-cad/packages/shared"
    "open-cloud-cad/packages/viewer-core"
    "open-cloud-cad/packages/web-viewer"
)
...
echo "  rush test       - Run unit tests"
echo "  rush lint       - Run linting"
echo "  rush rebuild    - Clean rebuild"
echo ""
